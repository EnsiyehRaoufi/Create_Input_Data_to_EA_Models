...
DATASET = 'agrold' #Dataset name should not contain any punctuations
...
#We should set proper attributes for assigning those attribute values as entity'slocal names in KG1 and KG2
...
TEST, TRAIN, VAL = 6, 3, 1 #How to split the reference alignment to be used for test, train, and validation set
